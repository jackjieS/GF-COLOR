...
namespace testdm
{
    partial class Battle : Form
    {
        ...
        private int x;
        public Battle(InstanceManager im,int x)
        {
            InitializeComponent();
            this.im = im;
            this.x = x;
        ...
        private void Battle_Load(object sender, EventArgs e)
        {
            ...
            if (im.gameData.User_battleInfo[x].Used == true)
            {
                this.Text = string.Format("战斗任务 {0} 进行中", x + 1);
                this.button1.Text = "保存";
            }
            else
            {
                this.Text = string.Format("战斗任务 {0} 空闲中", x + 1);
            ...
            if (im.gameData.User_battleInfo[x].Used == true)
            {
                ...
                comboBox1.Text = im.gameData.User_battleInfo[x].TaskName;

                comboBox2.Text = im.gameData.User_battleInfo[x].TaskType.ToString();

                comboBox14.Text = im.gameData.User_battleInfo[x].TaskMianTeam;
                comboBox13.Text = im.gameData.User_battleInfo[x].TaskSupportTeam1;
                checkBox1.Checked = im.gameData.User_battleInfo[x].ChoiceToFix;
                checkBox2.Checked = im.gameData.User_battleInfo[x].ChoiceToSupply;
                checkBox3.Checked = im.gameData.User_battleInfo[x].BattleLoopUnLockWindows;
                checkBox4.Checked = im.gameData.User_battleInfo[x].DismantleGunOrEquipment;
                checkBox6.Checked = im.gameData.User_battleInfo[x].SetMap;
                checkBox7.Checked = im.gameData.User_battleInfo[x].GunNeedWithDraw;
                comboBox8.SelectedIndex = im.gameData.User_battleInfo[x].EquipmentType;
                foreach (var x in im.gameData.User_battleInfo[x].BattleGunPostionMove)
                {
                    switch (x)
                    {
                        case 1: { checkBox8.Checked = true; break; }
                        case 2: { checkBox9.Checked = true; break; }
                        case 3: { checkBox10.Checked = true; break; }
                        case 4: { checkBox11.Checked = true; break; }
                        case 5: { checkBox12.Checked = true; break; }
                        case 6: { checkBox13.Checked = true; break; }
                        case 7: { checkBox14.Checked = true; break; }
                        case 8: { checkBox15.Checked = true; break; }
                        case 9: { checkBox16.Checked = true; break; }
                        default:
                            break;
                    }
                }
                ...
                if (im.gameData.User_battleInfo[x].FixType == 1)
                {
                    radioButton1.Checked = true;
                }
                else if (im.gameData.User_battleInfo[x].FixType == 2)
                {
                    radioButton2.Checked = true;
                }
                if (im.gameData.User_battleInfo[x].DismantleType == 0)
                {
                    radioButton3.Checked = true;
                }
                if (im.gameData.User_battleInfo[x].DismantleType == 1)
                {
                    radioButton4.Checked = true;
                }


                checkBox5.Checked = im.gameData.User_battleInfo[x].BattleSupport_plus;


                textBox4.Text = im.gameData.User_battleInfo[x].DismantlementGunCount.ToString();
                textBox1.Text = im.gameData.User_battleInfo[x].FixMaxTime.ToString();
                textBox2.Text = im.gameData.User_battleInfo[x].FixMintime.ToString();
                textBox3.Text = im.gameData.User_battleInfo[x].RoundInterval.ToString();
                textBox6.Text = im.gameData.User_battleInfo[x].FixMinPercentage.ToString();
                textBox7.Text = im.gameData.User_battleInfo[x].FixMaxPercentage.ToString();
                textBox8.Text = im.gameData.User_battleInfo[x].Team_SerrorTime.ToString();
                textBox9.Text = im.gameData.User_battleInfo[x].EquipmentUpdatePostion.ToString();
                textBox10.Text = im.gameData.User_battleInfo[x].LoopMaxTime.ToString();
                textBox11.Text = im.gameData.User_battleInfo[x].EquipmentUpdateCount.ToString();
                textBox12.Text = im.gameData.User_battleInfo[x].GunWithDrawTimedelay.ToString();
                textBox13.Text = im.gameData.User_battleInfo[x].BattleSupportRound.ToString();
                //page2


                //comboBox3.Text = im.gameData.User_AutobattleInfo[0].AutoBattleTeamName1;
                //comboBox4.Text = im.gameData.User_AutobattleInfo[0].AutoBattleTeamName2;
                //comboBox5.Text = im.gameData.User_AutobattleInfo[0].AutoBattleTeamName3;
                //comboBox6.Text = im.gameData.User_AutobattleInfo[0].AutoBattleTeamName4;
                //comboBox7.Text = im.gameData.User_AutobattleInfo[0].AutoBattleMap;
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            im.gameData.User_battleInfo[x].TaskName = comboBox1.Text;
            im.gameData.User_battleInfo[x].TaskMianTeam = comboBox14.Text;
            im.gameData.User_battleInfo[x].TaskSupportTeam1 = comboBox13.Text;
            im.gameData.User_battleInfo[x].TaskSupportTeam2 = comboBox9.Text;
            im.gameData.User_battleInfo[x].Team_SerrorTime = Int32.Parse(textBox8.Text);
            im.gameData.User_battleInfo[x].LoopMaxTime = Int32.Parse(textBox10.Text);

            im.gameData.User_battleInfo[x].ChoiceToFix = checkBox1.Checked;
            im.gameData.User_battleInfo[x].ChoiceToSupply = checkBox2.Checked;
            im.gameData.User_battleInfo[x].BattleLoopUnLockWindows = checkBox3.Checked;

            im.gameData.User_battleInfo[x].DismantleGunOrEquipment = checkBox4.Checked;
            im.gameData.User_battleInfo[x].SetMap = checkBox6.Checked;


            im.gameData.User_battleInfo[x].FixMaxTime = Int32.Parse(textBox1.Text);
            im.gameData.User_battleInfo[x].FixMintime = Int32.Parse(textBox2.Text);
            im.gameData.User_battleInfo[x].FixMinPercentage = Int32.Parse(textBox6.Text);
            im.gameData.User_battleInfo[x].FixMaxPercentage = Int32.Parse(textBox7.Text);
            im.gameData.User_battleInfo[x].RoundInterval = Int32.Parse(textBox3.Text);
            im.gameData.User_battleInfo[x].TaskType = Int32.Parse(comboBox2.Text);

            if (radioButton1.Checked == true)
            {
                im.gameData.User_battleInfo[x].FixType = 1;
            }
            else if (radioButton2.Checked == true)
            {
                im.gameData.User_battleInfo[x].FixType = 2;
            }

            //拆解或装备强化设置
            if (checkBox4.Checked == true)
            {
                im.gameData.User_battleInfo[x].DismantleGunOrEquipment = true;
                if (radioButton3.Checked == true)
                {
                    im.gameData.User_battleInfo[x].DismantleType = 0;
                    im.gameData.User_battleInfo[x].DismantlementGunCount = Convert.ToInt32(textBox4.Text);
                }
                if (radioButton4.Checked == true)
                {
                    im.gameData.User_battleInfo[x].DismantleType = 1;
                    im.gameData.User_battleInfo[x].EquipmentType = comboBox8.SelectedIndex;
                    im.gameData.User_battleInfo[x].EquipmentUpdatePostion = Convert.ToInt32(textBox9.Text);
                    im.gameData.User_battleInfo[x].EquipmentUpdateCount = Convert.ToInt32(textBox11.Text);
                }
            }
            im.gameData.User_battleInfo[x].BattleSupportRound = Convert.ToInt32(textBox13.Text);
            im.gameData.User_battleInfo[x].BattleSupport_plus = checkBox5.Checked;
            im.gameData.User_battleInfo[x].GunWithDrawTimedelay = Convert.ToDouble(textBox12.Text);
            //撤退代码
            BattleGunE(im.gameData.User_battleInfo[x].BattleGunPostionMove);
            im.gameData.User_battleInfo[x].GunNeedWithDraw = checkBox7.Checked;



            if(im.gameData.User_battleInfo[x].Used == false)
            {
                im.gameData.User_battleInfo[x].Used = true;
